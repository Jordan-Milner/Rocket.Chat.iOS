...
public class ReplyView: UIView {
    ...
    private func commonInit() {
        ...
        NotificationCenter.default.addObserver(forName: UIContentSizeCategory.NSNotification.Name.UIContentSizeCategoryDidChange, object: nil, queue: nil, using: { [weak self] _ in
            self?.setNeedsLayout()
        })
